...
function TaskManagement()
{
    ...
    //Khi page load lần đầu thì focus vào ô input
    useEffect(() =>
    {
            ...
            <div className="flex justify-center items-center mt-[10%] p-0 box-border">
                <div className="border rounded-md shadow-md py-5 px-20 min-w-[70%]">
                    ...
                    <form className="flex gap-4" onSubmit={ handleSubmitForm }>
                        <input ref={ inputRef } value={ taskValue } onChange={ handleChangeTask } placeholder="Nhập tên công việc" type="text" className="focus:border-blue-700 hover:shadow-md h-9 border outline-none px-4 rounded flex-1" />
